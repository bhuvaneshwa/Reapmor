...
export default function Hero() {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute sm:mx-0 xl:mx-14 sm:w-full m-24 top-1/4 left-1/5 transform -translate-y-1/2 text-left px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-[17px] font-light text-justify  text-white mb-8">
                Introducing India first digital agriculture directory, reimagining the industry with data-driven solutions for procurement, crop planning, and targeted marketing.
              </p>
