    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center font-sans">
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-8 px-4 md:px-8 lg:px-16 xl:px-24">
          <h1 className=" xs:text-[2.5rem] lg:text-left sm:text-5xl lg:text-6xl text-white font-extralight leading-normal tracking-wider sm:text-center xs:text-center mb-8" style={{ lineHeight: "1.4" }}>
          ...
          <p className="text-lg lg:text-left xl:text-left  xs:text-xl xs:text-center md:text-xl lg:text-xl xl:text-2xl sm:text-center text-white font-light mb-8 " style={{lineHeight: "2.25rem"}}>
