    ...
    <div>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-10 bg-green-600 dark:bg-white">
        <div className="container flex justify-between items-center mx-auto">
          <Link to="/" className="flex items-center p-2" aria-label="Back to homepage">
        ...
        >
          ...
          <li>
            <button
              ...
              className={`flex items-center justify-between w-full px-4 py-2 focus:outline-none ${isActive('/solution')}`}
            >
              Solutions
              <svg
          ...
          <li>
            <button
              onClick={toggleAbout}
              className={`flex items-center justify-between w-full px-4 py-2 focus:outline-none ${isActive('/about')}`}
            >
              About Us
              <svg
                className={`ml-2 w-4 h-4 transform ${
    ...
    <div className="container flex justify-between items-center">
      ...
      <ul className="flex justify-between items-center space-x-4">
        ...
        <li className="relative">
          <button
            onClick={toggleSolution}
            className={`flex items-center text-gray-800 dark:text-black px-4 py-2 focus:outline-none ${isActive('/solution')}`}
          >
            Solutions
            <svg
              className={`ml-2 w-4 h-4 transform ${
        ...
        <li className="relative">
          <button
            onClick={toggleAbout}
            className={`flex items-center text-gray-800 dark:text-black px-4 py-2 focus:outline-none ${isActive('/about')}`}
          >
            About Us
            <svg
              className={`ml-2 w-4 h-4 transform ${
